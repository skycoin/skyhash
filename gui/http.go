...
// Does NOT use HTTPS
func LaunchWebInterface(host, staticDir string, shm *skyhashmanager.SkyhashManager) error {
	...
	serve(listener, NewGUIMux(appLoc, shm))
	return nil
}
...
func NewGUIMux(appLoc string, shm *skyhashmanager.SkyhashManager) *http.ServeMux {
	...
	*/
	...
	//register handlers
	RegisterNodeManagerHandlers(mux, shm)
